...
// inventors.map(('First Name' && 'Last Name') => {
//     return 
// })
...
let inventorNamedAda = inventors.find((firstName) => {
    return firstName.first === 'Ada';
})
...
let isEveryone19OrOlder = devs.every((allDevs) => {
    const currentYear = new Date().getFullYear();
    return currentYear - allDevs.year >= 19;
})
