...
SELECT name, population, code FROM countries WHERE region = 'Southern Europe';
...
-- Write SQL query here
SELECT countrycode, percentage, isofficial FROM countrylanguages WHERE language = 'Italian';
countrycode | percentage | isofficial
-------------+------------+------------
 ARG         |        1.7 | f
 AUS         |        2.2 | f
 BEL         |        2.4 | f
...
-- Write SQL query here
SELECT name, countrycode  FROM cities WHERE name LIKE 'Serr%';
    name    | countrycode
------------+-------------
 Serra      | BRA
 Serravalle | SMR
...
-- Have I missed something here? Why is the capital and integer?
